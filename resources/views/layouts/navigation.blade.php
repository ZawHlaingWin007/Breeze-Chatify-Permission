                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div>
                                <span
                                    class="fi fi-{{ app()->currentLocale() == 'en' ? 'us' : app()->currentLocale() }}"></span>
                                <span class="ml-1">
                    ...
                    <x-slot name="content">
                        @foreach (config('app.locales') as $locale)
                            <x-dropdown-link :href="route('lang.switch', $locale['code'])" class="cursor-pointer" id="languageLink">
                                <span class="fi fi-{{ $locale['code'] == 'en' ? 'us' : $locale['code'] }}"></span>
                                <span class="ml-1">{{ $locale['name'] }}</span>
                            </x-dropdown-link>
                        @endforeach
                    </x-slot>
                </x-dropdown>
